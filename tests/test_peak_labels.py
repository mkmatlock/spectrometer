...
class PeakLabelTests(unittest.TestCase):
    ...
    def test_accept_multiple_labels_and_draw_all_after_selection_cleared(self):
        ...
        self.assertEqual(self.ui._scale_labels, {1000: 532.1})
        ...
        for key in '650':
            self.ui._label_key(key)
        self.ui._accept_label()
        self.assertEqual(self.ui._scale_labels, {1000: 532.1, 2500: 650.0})
        self.assertEqual(self.settings['scale'], {})
        pygame.font.init()
    ...
    def test_cancel_and_invalid_input_leave_settings_unchanged(self):
        ...
        self.ui._scale_labels[1000] = 532.1
        self.ui._label_peak()
    ...
    def test_labeled_peak_modify_cancel_delete_and_back(self):
        ...
        self.ui._scale_labels = deepcopy(self.settings['scale'])
        ...
        self.ui._accept_label()
        self.assertEqual(self.ui._scale_labels[1000], 532.2)
        self.ui._select_peak(tuple(self.ui._peaks.positions[0]))
        self.ui.buttons[2][2]()
        self.assertEqual(self.ui._scale_labels[1000], 532.2)
        self.ui._select_peak(tuple(self.ui._peaks.positions[0]))
        self.ui.buttons[1][2]()
        self.assertEqual(self.ui._scale_labels, {2500: 650.0})
